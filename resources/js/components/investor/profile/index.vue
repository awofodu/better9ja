                            ...
                            <div class="col-xl-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="image-input image-input-outline" id="kt_profile_avatar" style="background-image: url(../../../../../theme/html/demo1/dist/assets/media/users/blank.png)">
                                            <div class="image-input-wrapper" :style="'background-image: url(/uploads/form.photo)'"></div>
                                            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                                <i class="fa fa-pen icon-sm text-muted"></i>
                                                <input type="file" name="profile_avatar" @change="changePhoto" accept=".png, .jpg, .jpeg">
                                ...
                                <div class="my-5">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <select class="form-control form-control-solid" :disabled="disabled" v-model="form.bank_code">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group input-group-solid">
                                                ...
                                                <input type="number"
                                                       class="form-control form-control-solid" v-debounce:4s="checkAccountDetails"
                                                       v-model="form.account_number" :disabled="disabled" placeholder="Account Number"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group input-group-solid">
                                                ...
                                                <input type="text"
                                                       class="form-control form-control-solid"
                                                       v-model="form.account_name" disabled="disabled" placeholder="Account Name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="my-5">
                                    ...
                                    <div class="col-md-12 col-xxl-3 border-right-0 border-right-md border-bottom border-bottom-xxl-0">
                                        <div class="pt-30 pt-md-25 pb-15 px-5 text-center">
                                            ...
                                            <h4 class="font-size-h6 d-block font-weight-bold mb-7 text-dark-50">Your support pin for today</h4>
                                            <p class="mb-15 d-flex flex-column">
                                                <h6 class="text-primary">Your 4-Digit Support PIN is required when you want to grant your Guider access
                                                    to check and resolve issues on your account.
                                                </h6>
                                                <h6 class="text-primary">
                                                    Please always keep your PIN secret and should never disclosed to anyone beside your Guider.
                                                    You are only alowed to give it to your Guider when you believe your account may have an issue
                                                    in regards to Merging.
                                                </h6>
                                                <h6 class="text-primary">
                                                    Note that the system generates new Support PIN for your account everyday.
                                                </h6>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="my-5">
                                    <div class="card-footer bg-gray-100 border-top-0 text-right">
                                        ...
                                        <button type="button" @click="profileDetails" class="btn btn-light-primary font-weight-bold">Cancel</button>
                                    </div>
                                </div>
                            </div>
