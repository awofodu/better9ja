            ...
            <div class="card-spacer mt-n25">
                ...
                <div class="row m-0">
                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
						<div class="row">
							...
							<svg xmlns="http://www.w3.org/2000/svg"
								...
								<a href="#" class="text-warning font-weight-bold font-size-h6">Investment</a>
							</div>
							<div class="col-sm-6 text-warning font-weight-bold font-size-h2 mt-1">
								₦{{priceComma(investment_amount)}} ({{user.investments.length}})
							</div>
						</div>
                    ...
                    <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                        ...
                        <a href="#" class="text-primary font-weight-bold font-size-h6 mt-2">Withdrawal</a>
							</div>
							<div class="col-sm-6 text-primary font-weight-bold font-size-h2 mt-1">
								₦{{priceComma(withdrawal_amount)}} ({{withdrawals}})
							</div>
						</div>
                    </div>
                </div>
                ...
                <div class="row m-0">
                    <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                        ...
                        <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">Referrals</a>
                    </div>
                    <div class="col bg-light-success px-6 py-8 rounded-xl">
                        ...
                        <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Level</a>
                    </div>
                </div>
                <!--end::Row-->
            </div>
